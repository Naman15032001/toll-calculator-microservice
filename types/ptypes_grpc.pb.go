...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregrateRequest, opts ...grpc.CallOption) (*None, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregrateRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregrateRequest) (*None, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregrateRequest) (*None, error) {
...
func _Aggregator_Aggregate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).Aggregate(ctx, req.(*AggregrateRequest))
	}
