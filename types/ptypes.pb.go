...
func (x *AggregrateRequest) Reset() {
	*x = AggregrateRequest{}
...
func (x *AggregrateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AggregrateRequest) ProtoMessage() {}

func (x *AggregrateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_types_ptypes_proto_msgTypes[0]
...
// Deprecated: Use AggregrateRequest.ProtoReflect.Descriptor instead.
func (*AggregrateRequest) Descriptor() ([]byte, []int) {
	return file_types_ptypes_proto_rawDescGZIP(), []int{0}
}

func (x *AggregrateRequest) GetObuId() int32 {
	if x != nil {
		return x.ObuId
	}
	return 0
...
func (x *AggregrateRequest) GetValue() float64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *AggregrateRequest) GetUnix() int64 {
	if x != nil {
		return x.Unix
	}
	return 0
...
var file_types_ptypes_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x53, 0x0a, 0x11, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x72, 0x61,
	...
	0x65, 0x22, 0x29, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x4f, 0x62, 0x75, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x4f, 0x62, 0x75, 0x49, 0x64, 0x32, 0x34, 0x0a, 0x0a,
	...
	0x72, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x05, 0x2e, 0x4e, 0x6f,
	0x6e, 0x65, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x4e, 0x61, 0x6d, 0x61, 0x6e, 0x31, 0x35, 0x30, 0x33, 0x32, 0x30, 0x30, 0x31, 0x2f, 0x74,
...
var file_types_ptypes_proto_goTypes = []interface{}{
	(*AggregrateRequest)(nil), // 0: AggregrateRequest
	(*None)(nil),              // 1: None
	(*GetInvoiceRequest)(nil), // 2: GetInvoiceRequest
}
var file_types_ptypes_proto_depIdxs = []int32{
	0, // 0: Aggregator.Aggregate:input_type -> AggregrateRequest
...
func file_types_ptypes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_types_ptypes_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AggregrateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
